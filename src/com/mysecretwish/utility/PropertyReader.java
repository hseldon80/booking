package com.mysecretwish.utility;
...
public class PropertyReader {
    ...
    private PropertyReader()
    {
        ...
        try
        {
            messages.load(getClass().getClassLoader().getResourceAsStream("dbConnection.properties"));
        }
        catch(IOException e)
        {
    ...
    {
        if(pr == null)
            synchronized(com.mysecretwish.utility.PropertyReader.class)
            {
                if(pr == null)
