package com.mysecretwish.filter;
...
import com.mysecretwish.bean.SessionBean;
...
public class Filtro implements Filter {
	...
	private final String AUTORIZZAZIONI_PROPERTIES = "/com/mysecretwish/filter/autorizzazioni.mysecret";
    /**
     * Default constructor. 
     */
    public Filtro() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		// TODO Auto-generated method stub
				...
				try {
					if (req.getRequestURI().indexOf("/MySecretWish/javax.faces.resource/")!=-1) {
						autorizzato = true;
					} else {			
		        ...
		        { 	
		          if (autorizzato) {  
		              ...
		              resp.sendRedirect(request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+"/MySecretWish/notAuthorized.xhtml");
		          }
		        }
	}
	...
	private boolean checkAutorizzazione(SessionBean utente, String contextPath, String reqURI)
	{
		...
		if ( utente !=null )
			autorizzazioni = autorizzazioniMap.get( ""+utente.getUtente_business());
		...
		// TODO: Escludere Ajax Request(s)
		Model authModel = new Model(utente.getUtente_business(), reqURI);
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		SESSION_USERNAME_ATTR = "nomeUtente";
